        ...
        <div>
            ...
            <section className="  w-full h-auto bg-cover  text-black text-center  flex flex-col gap-10 justify-center items-center bg-[url('public/images/home-bg.jpg')] ">
                ...
                <div className='flex gap-4 mb-20 '>
                    <div class=" w-60  min-h-72 flex flex-col bg-white border shadow-sm p-1 justify-center items-center text-center    bg-[url('public/images/002041.jpg')] bg-fill border-none">
                        <div className='max-h-62'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" className="w-16 h-16 text-center ml-20 ">
                    ...
                    <div class=" w-60  min-h-72 flex flex-col bg-white border shadow-sm p-1 justify-center items-center text-center   bg-[url('public/images/002031.jpg')] bg-fill border-none">
                        <div className='max-h-62'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" className="w-16 h-16 text-center ml-20 ">
                                <path fill-rule="evenodd" d="M6.75 2.25A.75.75 0 0 1 7.5 3v1.5h9V3A.75.75 0 0 1 18 3v1.5h.75a3 3 0 0 1 3 3v11.25a3 3 0 0 1-3 3H5.25a3 3 0 0 1-3-3V7.5a3 3 0 0 1 3-3H6V3a.75.75 0 0 1 .75-.75Zm13.5
                             9a1.5 1.5 0 0 0-1.5-1.5H5.25a1.5 1.5 0 0 0-1.5 1.5v7.5a1.5 1.5 0 0 0 1.5 1.5h13.5a1.5 1.5 0 0 0 1.5-1.5v-7.5Z" clip-rule="evenodd" />
            ...
            <section className=' w-full flex flex-col gap-10 justify-center items-center  '>
                <div>
                    <h1 className='text-5xl font-bold text-white tracking-widest mt-10 font-montserrat-subrayada'>Key Invitees</h1>
                </div>
                <div className=' flex justify-center items-center gap-4 mb-20'>
                    <div class=" w-full mt-10  min-h-80 flex flex-col justify-center items-center rounded-xl bg-white border shadow-sm  p-10     ">
                        ...
                        <h1 className='text-center'>Software Test & Digital Transformation Consultant, Maargam IT, London, UK.</h1>
                    </div>
                </div>
            </section>
            ...
            <section className=' w-full flex flex-col  text-white gap-10 justify-center items-center bg-red-600 '>
                <div>
                    <h1 className='text-5xl font-bold text-white tracking-widest mt-10 font-montserrat-subrayada '>Chief Patrons</h1>
                </div>
                {/* <div className=' flex gap-4 mb-20 justify-center items-center flex-wrap'> */}
                <div className=' w-4/12   flex justify-center items-center gap-4 mb-20'>
                    <div class=" w-full h-80 mt-10 flex flex-col justify-center items-center rounded-xl bg-white border shadow-sm  bg-[url('public/images/002051.jpg')] bg-fill ">
            ...
            <section className='flex justify-center items-center gap-10 my-20 '>
                <div class=" w-60  min-h-80 flex flex-col bg-white border shadow-sm  rounded-xl p-4 md:p-5 dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70  bg-[url('public/images/002031.jpg')] bg-fill border-none ">
                <h3 className='font-roboto text-20 text-center font-bold'>Academicians</h3>
                <h1 className='font-roboto text-20 text-center font-bold'>INR</h1>
                <h1 className='font-roboto text-20 text-center font-bold'>1</h1>
                <button className='uppercase w-40 rounded-lg h-10 text-white bg-black font-medium '>Register here</button>
                


                </div>
                <div class=" w-60  min-h-80 flex flex-col bg-white border shadow-sm  rounded-xl p-4 md:p-5 dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70  bg-[url('public/images/002041.jpg')] bg-fill border-none ">
            ...
            <section className='text-center mt-36'>
                <h1 className='text-5xl text-white font-bold my-10 font-montserrat-subrayada'>Contact Us</h1>
                <h2 className='text-4xl text-white font-bold'>V.R.S. College of Engineering & Technology,</h2>
                <h3 className='text-2xl text-white my-6'>(Reaccredited by NAAC and An ISO 9001:2008 Recertified Institution)</h3>
                <h1 className='text-2xl text-white mb-14'>Arasur - 607 107,
                    <br />
                    Villupuram District
                    <br />
